...
var totalCitasChart = new Chart(document.getElementById("total-cita"), config);
...
var canvasContext = document.getElementById('ingresos-diarios').getContext('2d');

// Datos del gráfico (ingresos por barbero)
var datosGrafico = {
    labels: ['Juan', 'Carlos', 'Sofía', 'María', 'Pedro', 'Ana', 'Luis', 'Miguel'], // Nombres de los 8 barberos
    datasets: [{
